...
def input_options():
    ...
    parser.add_argument('--gpu', type=int, default=1, help='gpu id to use(e.g. 0,1,2,3)')
    parser.add_argument('--round_num', type=int, default=151, help='number of round in comm')
    ...
    parser.add_argument('--server', type=str, default='mimic', help='server, options: fedavg, fdms, mimic, reba, fedasync;')
    ...
    parser.add_argument('--C', type=int, default=1000000, help='comptu. one sample. cifar 200000',)
