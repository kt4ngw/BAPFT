...
class Metrics(object):
    def __init__(self, options, clients, name=''):
        ...
        self.waiting_time = [0] * num_rounds
    ...
    def update_waiting_time(self, round_i, waiting_time):
        self.waiting_time[round_i] = waiting_time
    ...
    def write(self):
        ...
        metrics['waiting_time'] = self.waiting_time
